...
```
malaria-ml-detection/
├── README.md
├── images/                              # All paper figures
│   ├── fig1_performance_comparison.png
│   ├── fig2_roc_curves.png
│   ├── fig3_precision_recall_curves.png
│   ├── fig4_confusion_matrices.png
│   ├── fig5_metrics_heatmap.png
│   ├── fig6_feature_importance.png
│   ├── fig7_pca_projection.png
│   ├── fig8_training_time_auc.png
│   └── fig9_crossvalidation_f1.png
├── data/
│   └── cell_images/                     # NIH/NLM dataset (download separately)
├── src/
│   ├── feature_extraction.py            # 33-feature pipeline
